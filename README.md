...
### Покерный стол (12 игроков)
![Table 12 players](docs/table-12.png)

Полноценный стол с 12 игроками, общими картами, банком, MOON логотипом и таблицей комбинаций.

### Стол на 2 игрока (heads-up)
![Table 2 players](docs/table-2.png)

### Стол на 6 игроков
![Table 6 players](docs/table-6.png)

### Мобильная версия
![Mobile](docs/mobile.png)

Полный адаптив для телефонов в портретном и ландшафтном режиме.

### Превью
Откройте `/preview` для живого просмотра стола с ползунком количества игроков (2-15).
